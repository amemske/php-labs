...
- traits can also provide default implementations for  methods.
- NOTE!!!! A trait DOES NOT have its own properties or variables but they can use variables defined in that class
that uses the trait.
*/
...
- Just like any classs an abstract classes can contain both abstract and concrete methods,(while an interface only has
abstract methods) and they can also define instance variables.
